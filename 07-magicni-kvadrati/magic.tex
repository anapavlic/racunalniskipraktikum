...
\usepackage{url}
\usepackage{graphicx}
\usepackage{amsmath}  % Za matematične izraze
\usepackage{amsthm}   % Za okolja izreka, definicije in dokazov
...
% Vključevanje slike na sredino strani
\begin{center}
   \includegraphics{slika.pdf}  % Tukaj vključimo sliko
\end{center}
...
\tableofcontents  % Izpiše kazalo vsebine
...
\label{table:mag3}  % Oznaka za tabelo
\begin{tabular}{|c|c|c|}
\hline
8 & 1 & 6 \\\hline
3 & 5 & 7 \\\hline
...
\begin{table}[h]
\centering
\caption{Kvadrat Lo Shu}  % Napis nad tabelo
\label{table:loshu}  % Oznaka za tabelo
\begin{tabular}{|c|c|c|}
\hline
4 & 9 & 2 \\\hline
3 & 5 & 7 \\\hline
...
\begin{table}[h]
\centering
\caption{Kvadrat Kubera-Kolam}  % Napis nad tabelo
\label{table:kubera}  % Oznaka za tabelo
\begin{tabular}{|c|c|c|}
\hline
23 & 28 & 21 \\\hline
22 & 24 & 26 \\\hline
...
\begin{figure}[h]
   \centering
   \includegraphics[scale=1.3]{durer.png}  % Naloži sliko in nastavi njeno velikost
   \caption{Dürerjev magični kvadrat}  % Napis nad sliko
   \label{fig:durer}  % Oznaka slike za kasnejše sklicevanje
   \end{figure}
...
\begin{table}[h]
\centering
\caption{Dürerjev magični kvadrat $4 \times 4$}  % Napis nad tabelo
\label{table:durer}  % Oznaka za tabelo
...
\begin{figure}[h]
   \centering
   \includegraphics[scale=1.3]{sagrada.png}  % Naloži sliko in nastavi njeno velikost
   \caption{Pasijonska fasada, Sagrada Família}  % Napis nad sliko
   \label{fig:sagrada}  % Oznaka slike za kasnejše sklicevanje
   \end{figure}
...
% Naslov tabele z oznako
\begin{table}[h]
   \centering
   \caption{Pasijonska fasada, Sagrada Família}  % Naslov nad tabelo
   \label{table:sagrada}  % Oznaka tabele za sklicevanje v besedilu
   
   \begin{tabular}{|c|c|c|c|}  % Množica stolpcev (| pomeni ločene stolpce z vejico)
   \hline  % Vrstica, ki ločuje glavo tabele
   1 & 14 & 14 & 4 \\ \hline
   11 & 7 & 6 & 9 \\ \hline
   8 & 10 & 10 & 5 \\ \hline
   13 & 2 & 3 & 15 \\ \hline
...
\begin{izrek}% Začetek okolja izrek
   Magična konstanta normalnega magičnega kvadrata reda !!
   je enaka
   \begin{equation}
      \label{eq:mc}% oznaka: eq:mc
      M_2(n) = \frac{1}{2} n(n^2+1)
   \end{equation}
\end{izrek}% Konec okolja izrek

\begin{proof}% Začetek dokaza
   ...
   enaka številu $M_2(n)$. \ref{eq:numbers} in \ref{eq:mc} % sklica: eq:numbers, eq:numbers
\end{proof}% Konec dokaza
...
\begin{definicija}% \begin{definicija}
...
\begin{thebibliography}{99}
   ...
   \bibitem{bessy} Frénicle de Bessy, A. (1693). \emph{Magični kvadrati}. 
   
   \bibitem{gardner} Gardner, M. (1982). \emph{Mathematical Games: The Magic Squares of Lo Shu}. Scientific American.
   
   \bibitem{schroeppel} Schroeppel, R. (1973). \emph{The Calculation of Normal Magic Squares of Order 5}. 
   
   \bibitem{pinn} Pinn, J., Wieczerkowski, M. (Year). \emph{Monte Carlo Simulations of Magic Squares}. 
